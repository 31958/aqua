...
public class GlobalVariables {
    ...
    public static final String uploadpost = "http://elitegateinternational.co.uk/uploadpost.php";
    ...
    public static final String token = "http://elitegateinternational.co.uk/token.php";
